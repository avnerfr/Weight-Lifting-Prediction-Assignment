...
print(xtable(table(comp[,])/apply(table(comp[,]),2,sum)), type = "html")
...
```{r, cache = TRUE, fig.align='center' ,echo=TRUE, results='asis'}
...
print(xtable(table(compt[,])/apply(table(compt[,]),2,sum)), type = "html")

confusionMatrix(compt[,1],compt[,2])$overall
confusionMatrix(compt[,1],compt[,2])$byClass
