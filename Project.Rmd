...
# TODO
create a repo
add the image( locations) and files to the repo 
add link to image
...
and can be found in the [following link](http://groupware.les.inf.puc-rio.br/har)

The purpose of the study is to attempt to determine weather it is possible to determine quality of fitness center exercise.
...
![on-body sensing schema](https://github.com/avnerfr/Weight-Lifting-Prediction-Assignment/lon-body sensing schema.png)

Each of the sensors that was used has 3 elements it is able:
...
According to the shape of the data, I decide to build 4 different random forest models, one for each sensor and combine the results using majority vote algoritm.
In addition, I decided to pre-process the data prior to modeling. the preprocessing I did where:
...
* Add aggregations to the data:
      ...
      + calculate amplitude of megnetic sensor X,Y and Z values
* Run PCA transform and use the top 90%
 

![on-body sensing schema](https://github.com/avnerfr/Weight-Lifting-Prediction-Assignment/diagram.png)
